...
add_action( 'wp_enqueue_scripts', 'unhook_parent_style', 261 );
...
add_action( 'wp_enqueue_scripts', 'child_theme_configurator_css', 1251 );
...
add_action('wp_enqueue_scripts', 'scripts_and_styles',2091);
