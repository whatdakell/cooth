...
add_action( 'wp_enqueue_scripts', 'unhook_parent_style', 23 );
...
add_action( 'wp_enqueue_scripts', 'child_theme_configurator_css', 121 );
...
add_action('wp_enqueue_scripts', 'scripts_and_styles',204);
